...
export function BoardFiltersBar({ filters, onChange, totalCards, filteredCards, labels }: BoardFiltersBarProps) {
  ...
  const clearFilters = () => onChange({ types: [], priorities: [], labelIds: [] })
